...
AGENT_CODEX_CMD="codex exec --yolo --skip-git-repo-check -m gpt-5.5 -c model_reasoning_effort=\"xhigh\" -c service_tier=\"priority\" -"
AGENT_CODEX_INTERACTIVE_CMD="codex --yolo -m gpt-5.5 -c model_reasoning_effort=\"xhigh\" -c service_tier=\"priority\" {prompt}"
